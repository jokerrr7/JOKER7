...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ JOKER ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ JOKER ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ JOKER ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-JOKER/Files_Joker/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1765160742,1646796547}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOKER.")  
...
function plugin_Joker(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Joker and msg then
pre_msg = plugin.Joker(msg)
end
end
end
...
os.execute('wget https://raw.githubusercontent.com/SRC-JOKER/JOKER/main/JOKER.lua')
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الجروبات الان » { '..#group..' }'..JOKERk..''..JOKER..'\n℘︙  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."JOKER:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."JOKER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."JOKER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."JOKER:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."JOKER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
℘ ⦑ SOURCE JOKER ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/BLACK_TEAM_4)
℘︙ [Source programmer](t.me/eljo_ker_m)  
℘︙ [Source programmer](t.me/PHP57) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS JOKER](t.me/JOK_ER_7bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-JOKER/Files_JOKER/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-JOKER/Files_JOKER/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-Joker")
...
function Function_Joker(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Joker, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Joker, nil)
return false 
end
...
' }\n'..' ℘︙  الايدي بالصوره » { '..idph..
' }\n'..' ℘︙  الرفع » { '..setadd..
' }\n'..' ℘︙  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ JOKER ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ قناة سورس دراكون ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOKER.](t.me/BLACK_TEAM_4) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Joker:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Joker:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Joker:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Joker:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Joker:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Joker:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Joker:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Joker:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Joker:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Joker:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Joker:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Joker:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Joker:List:Rd:Sudo")
end
...
database:set(bot_id.."BLACK_TEAM_4:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."BLACK_TEAM_4:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BLACK_TEAM_4:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BLACK_TEAM_4:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."BLACK_TEAM_4:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."BLACK_TEAM_4:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Joker:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Joker:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Joker:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Joker:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Joker:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Joker:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Joker:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Joker:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"℘︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:Joker:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Joker:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Joker:Add:Rd:Sudo:Text2"..text)   
...
{
{text = 'JOKER 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/BLACK_TEAM_4"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ JOKER ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 JOKER. ](t.me/BLACK_TEAM_4)➤ ')
end
